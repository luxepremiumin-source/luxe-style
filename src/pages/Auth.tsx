    ...
    >
      <div className="flex-1 relative">
        ...
        <div className="relative flex-1 flex items-center justify-center px-4 py-12">
          <Card className="mx-auto mt-10 md:mt-16 w-full max-w-md min-w-[350px] pb-0 border border-white/10 bg-black/70 text-white shadow-[0_0_50px_rgba(255,255,255,0.2)] backdrop-blur-xl">
            {step === "signIn" ? (
              <>
