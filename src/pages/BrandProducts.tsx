...
export default function BrandProducts() {
  ...
  const products = allProducts?.filter(product => 
    product.name.toLowerCase().includes(decodeURIComponent(brandName).toLowerCase())
  );
  ...
  const brandDisplayName = decodeURIComponent(brandName)
    .split(' ')
        ...
        <section className="bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="mb-8">
              ...
              <p className="text-gray-300 mt-2">Explore our {brandDisplayName} collection.</p>
            </div>
            ...
            {!products ? (
              ...
              <div className="text-center py-20">
                <p className="text-gray-300">No products found for this brand.</p>
              </div>
            ) : (
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                          ...
                          {currentImage ? (
                            ...
                            <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
                              <span className="text-gray-700 font-medium">
                                {prettyCategory[product.category] ?? product.category}
                              </span>
                            </div>
                          )}
                          ...
                          <div className="mt-3 flex gap-2">
                            ...
                            <Button
                              ...
                              onClick={(e) => {
                                ...
                                const message = `Hi! I'm interested in "${product.name}" (${prettyCategory[product.category] ?? product.category}). Price: ₹${product.price.toLocaleString()}${product.originalPrice ? ` (MRP ₹${product.originalPrice.toLocaleString()})` : ""}. Link: ${link}`;
